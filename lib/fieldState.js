...
var FieldState = /** @class */ (function (_super) {
    ...
    function FieldState(initialValue, delay) {
        ...
        _this.addDisposer(mobx_1.reaction(function () { return _this._value; }, 
        ...
        utils_1.debounce(function () {
            if (_this.value !== _this._value) {
                mobx_1.runInAction('sync-value-when-_value-changed', function () {
        ...
        _this.addDisposer(mobx_1.reaction(function () { return _this.validated && !_this.hasError; }, function (validateOk) { return validateOk && (_this.$ = _this.value); }, { name: 'sync-$-when-validatedOk' }));
    ...
    Object.defineProperty(FieldState.prototype, "validating", {
         ...
         */
        get: function () {
            return this.validationDisabled ? false : this._validateStatus === types_1.ValidateStatus.Validating;
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(FieldState.prototype, "validated", {
         ...
         */
        get: function () {
            return this.validationDisabled ? false : this._validateStatus === types_1.ValidateStatus.Validated;
        },
        enumerable: true,
        configurable: true
    });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        mobx_1.runInAction('activate-and-sync-_value-when-validate', function () {
                            _this._activated = true;
