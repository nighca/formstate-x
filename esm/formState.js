...
var FormState = /** @class */ (function (_super) {
    ...
    function FormState(initialFields) {
        ...
        _this.mode = isArrayLike(initialFields) ? 'array' : 'object';
        _this.$ = initialFields;
        if (!isObservable(_this.$)) {
            _this.$ = observable(_this.$, undefined, { deep: false });
        }
        // auto activate: any field activated -> form activated
        _this.addDisposer(reaction(function () { return _this.fields.some(function (field) { return field._activated; }); }, function (someFieldActivated) { return someFieldActivated && !_this._activated && (_this._activated = true); }, { fireImmediately: true }));
    ...
    Object.defineProperty(FormState.prototype, "validating", {
        ...
        get: function () {
            ...
            return (this._validateStatus === ValidateStatus.Validating
    ...
    Object.defineProperty(FormState.prototype, "validated", {
        ...
        get: function () {
            ...
            return this._validateStatus === ValidateStatus.Validated && this.fields.every(function (field) { return field.validationDisabled || field.validated; });
        },
        enumerable: true,
        configurable: true
    });
    ...
    FormState.prototype.validate = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        runInAction('activate-when-validate', function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!isPromiseLike(validation.response)) return [3 /*break*/, 2];
